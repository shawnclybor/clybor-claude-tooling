...
Auto-loaded governance read on every non-trivial request. Kept small on purpose — anything domain-specific belongs in a per-project rule file or a plugin, not here.
