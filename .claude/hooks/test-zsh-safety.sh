...
allows    "POSIX single ="     '[ a = b ] || echo differ'
zsh_clean "POSIX single ="     '[ a = b ] || echo differ' 'differ'
allows    "test builtin single =" 'test a = b || echo differ'
zsh_clean "test builtin single =" 'test a = b || echo differ' 'differ'
allows    "quoted single ="    '[ "$HOME" = "$HOME" ] && echo same'
zsh_clean "quoted single ="    '[ "$HOME" = "$HOME" ] && echo same' 'same'
